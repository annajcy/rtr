...
public:
    ...
    Engine_runtime_async(const Engine_runtime_descriptor& descriptor) {
    ...
    static std::shared_ptr<Engine_runtime_async> create(const Engine_runtime_descriptor& descriptor) {
        return std::make_shared<Engine_runtime_async>(descriptor);
    }

    virtual ~Engine_runtime_async() {
